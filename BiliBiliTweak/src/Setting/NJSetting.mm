...
static NJShareManager * _logos_method$_ungrouped$BBPhoneSettingMainVC$nj_shareManager(_LOGOS_SELF_TYPE_NORMAL BBPhoneSettingMainVC* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
