#line 1 "/Users/touchworld/Documents/iOSDisassembler/hook/bilibili/BiliBiliMApp/BiliBiliMDDylib/Logos/DetailAd.xm"
...
@class BBAdUGCRcmdModel; @class IGListAdapter; @class BBAdUGCContext; 
...
#line 10 "/Users/touchworld/Documents/iOSDisassembler/hook/bilibili/BiliBiliMApp/BiliBiliMDDylib/Logos/DetailAd.xm"
...
__attribute__((used)) static NSNumber * _logos_property$_ungrouped$IGListAdapter$njAdMerchandiseViewIndexPathFlag(IGListAdapter * __unused self, SEL __unused _cmd) { return (NSNumber *)objc_getAssociatedObject(self, (void *)_logos_property$_ungrouped$IGListAdapter$njAdMerchandiseViewIndexPathFlag); }; __attribute__((used)) static void _logos_property$_ungrouped$IGListAdapter$setNjAdMerchandiseViewIndexPathFlag(IGListAdapter * __unused self, SEL __unused _cmd, NSNumber * rawValue) { objc_setAssociatedObject(self, (void *)_logos_property$_ungrouped$IGListAdapter$njAdMerchandiseViewIndexPathFlag, rawValue, OBJC_ASSOCIATION_RETAIN_NONATOMIC); }
...
static id _logos_method$_ungrouped$IGListAdapter$collectionView$cellForItemAtIndexPath$(_LOGOS_SELF_TYPE_NORMAL IGListAdapter* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, UICollectionView * view, NSIndexPath * path) {
    ...
    if ([cell.reuseIdentifier isEqualToString:@"AdMerchandiseViewBBVideoModule.VDViewSectionControllerCell"]) {
        ...
        NSLog(@"-[<IGListAdapter: %p> collectionView:%@ cellForItemAtIndexPath:%@]: %@, %@, %@", self, view, path, ((NSString *)@"cxzcxz"), (path), (self.njAdMerchandiseViewIndexPathFlag));
