...
@class BBLiveBaseAppointmentCardView; @class BBLiveBasePopularHotRankEntryView; @class BBLiveTopRightEntranceManager; @class BBLiveBaseAppointmentEntryView; @class BBLiveBaseMixedRankEntryView; @class BBLiveVerticalCenterBar; @class BBLiveRevenueCardsContentView; @class BBLiveBasePopularRankEntryView; @class BBLiveBaseUserRankListEntryView; @class BBLiveChainView; @class BBLiveFunctionCardTaskManager; @class BBLiveBaseAreaRankEntryView; 
...
static BBLiveTopRightEntranceManager* _logos_method$_ungrouped$BBLiveTopRightEntranceManager$init(_LOGOS_SELF_TYPE_INIT BBLiveTopRightEntranceManager* __unused self, SEL __unused _cmd) _LOGOS_RETURN_RETAINED {
    NSLog(@"-[<BBLiveTopRightEntranceManager: %p> init]: %@", self, (nj_logPrefix));
    return nil;
}
...
#line 127 "/Users/touchworld/Documents/iOSDisassembler/hook/bilibili/BiliBiliTweak/BiliBiliTweak/src/Home/Live/NJLiveDetailAd.xm"
