...
@class VKSettingViewSelectModel; @class NSArray; @class IJKFFMoviePlayerControllerFFPlay; @class BBPlayerPortraitScreenBottomWidget; @class BBPlayerOperationTagService; @class BBPlayerSupportedPlaybackRate; @class BBPlayerUpTagWidget; @class BBPlayerNavigationWidget; @class BBPlayerPlayerRateModel; @class BBPlayerBizGotoStoryWidget; 
...
static BBPlayerNavigationWidget* _logos_method$App$BBPlayerNavigationWidget$initWithContext$config$(_LOGOS_SELF_TYPE_INIT BBPlayerNavigationWidget* __unused self, SEL __unused _cmd, id context, id config) _LOGOS_RETURN_RETAINED {
    return _logos_orig$App$BBPlayerNavigationWidget$initWithContext$config$(self, _cmd, context, config);
}

static void _logos_method$App$BBPlayerNavigationWidget$didLayoutSubWidgets(_LOGOS_SELF_TYPE_NORMAL BBPlayerNavigationWidget* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    _logos_orig$App$BBPlayerNavigationWidget$didLayoutSubWidgets(self, _cmd);
    NSLog(@"%@:%@-%p-%s", nj_logPrefix, NSStringFromClass([(id)self class]), self, __FUNCTION__);
}

static void _logos_method$App$BBPlayerNavigationWidget$pushWidget$animated$completion$(_LOGOS_SELF_TYPE_NORMAL BBPlayerNavigationWidget* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, id widget, _Bool animated, id completion) {
    _logos_orig$App$BBPlayerNavigationWidget$pushWidget$animated$completion$(self, _cmd, widget, animated, completion);
}

static void _logos_method$App$BBPlayerNavigationWidget$addWidget$animated$completion$(_LOGOS_SELF_TYPE_NORMAL BBPlayerNavigationWidget* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, id widget, _Bool animated, id completion) {
    _logos_orig$App$BBPlayerNavigationWidget$addWidget$animated$completion$(self, _cmd, widget, animated, completion);
}
